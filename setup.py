...
verinfofilename = os.path.realpath("."+os.path.sep+os.path.sep+"pyuntar.py")
...
pymodule['description'] = 'Python library/module to untar files.'
pymodule['license'] = 'Revised BSD License'
pymodule['keywords'] = 'untar pyuntar python python-untar'
pymodule['url'] = 'https://github.com/GameMaker2k/PyUnTAR'
pymodule['downloadurl'] = 'https://github.com/GameMaker2k/PyUnTAR/archive/master.tar.gz'
pymodule['longdescription'] = 'Python library/module to untar files.'
pymodule['platforms'] = 'OS Independent'
pymodule['zipsafe'] = True
pymodule['pymodules'] = ['pyuntar']
